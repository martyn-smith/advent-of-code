...
fn test_day_10() {
    ...
    assert_eq!(326, aoc10::part_1(&input));
}

#[test]
fn test_day_11() {
    let input = aoc11::get_input();
    assert_eq!(2720, aoc11::part_1(&input));
}

#[test]
fn test_day_12() {
    let input = aoc12::get_input();
    assert_eq!(9441, aoc12::part_1(&input));
    assert_eq!(503560201099704, aoc12::part_2(&input));
}
...
fn test_day_14() {
    ...
    assert_eq!(751038, aoc14::part_1(&input));
    assert_eq!(2074843, aoc14::part_1(&input));
}
#[test]
fn test_day_17() {
    let input = aoc17::get_input();
    assert_eq!(5620, aoc17::part_1(&input));
}
